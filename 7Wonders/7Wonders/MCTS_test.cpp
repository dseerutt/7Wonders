...
namespace mcts
{
	...
	MCTS_test::MCTS_test(MCTSImplementation& g) : openings_(g)
	{
		play(g);
	}

	void MCTS_test::test_openings(MCTSImplementation& g, int nb_learning, int nb_testing)
	{
	...
	int MCTS_test::select_move(MCTSImplementation& game)
	{
	...
	void MCTS_test::play(MCTSImplementation& g)
	{
	...
	void MCTS_test::self_play_learn_openings(MCTSImplementation& g, int n)
	{
	...
	void MCTS_test::self_play(MCTSImplementation& g, int n, bool with_openings)
	{
		/*auto state = g.get_state();
	...
	void MCTS_test::self_play(MCTSImplementation& g)
	{
